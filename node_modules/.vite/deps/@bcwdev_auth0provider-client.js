...
var p = h("object" == typeof globalThis && globalThis) || h("object" == typeof window && window) || h("object" == typeof self && self) || h("object" == typeof s && s) || /* @__PURE__ */ function() {
  return this;
...
var ue = l(function(e2) {
  ...
  })("versions", []).push({ version: "3.22.4", mode: "global", copyright: "© 2014-2022 Denis Pushkarev (zloirock.ru)", license: "https://github.com/zloirock/core-js/blob/v3.22.4/LICENSE", source: "https://github.com/zloirock/core-js" });
});
var le = p.Object;
var fe = function(e2) {
  return le(L(e2));
...
var Ht = p.Object;
var Dt = "Arguments" == K(/* @__PURE__ */ function() {
  return arguments;
}());
...
var uc = function(e2) {
  ...
  var n2 = e2.leeway || 60, r2 = new Date(e2.now || Date.now()), o2 = /* @__PURE__ */ new Date(0), i2 = /* @__PURE__ */ new Date(0), c2 = /* @__PURE__ */ new Date(0);
...
// node_modules/@bcwdev/auth0provider-client/lib/EventEmitter.js
var EventEmitter = class {
   ...
   */
  on(event, fn2, thisContext = null) {
    if (typeof fn2 != "function") {
      return;
    }
    this._listeners[event] = this._listeners[event] || [];
    fn2.ctx = thisContext;
    this._listeners[event].push(fn2);
  }
  /**
   * @param {string | number} event
   * @param {function} fn
  ...
  off(event, fn2) {
    this._listeners[event] = this._listeners[event] || [];
    const i2 = this._listeners[event].indexOf(fn2);
    if (i2 === -1) {
      return;
    }
  ...
  emit(event, payload) {
    ...
    for (let i2 = 0; i2 < length; i2++) {
      let fn2 = this._listeners[event][i2];
      fn2.ctx ? fn2.call(fn2.ctx, payload) : fn2(payload);
    }
  }
};

// node_modules/@bcwdev/auth0provider-client/lib/index.js
var DEFAULT_REDIRECT_CALLBACK = () => window.history.replaceState({}, document.title, window.location.pathname);
var instance = {};
var AuthPlugin = class extends EventEmitter {
  constructor(options = {}) {
    super();
    instance = this;
  ...
  loginWithRedirect(o2 = {}) {
    if (!o2.appState) {
      o2.redirectUri = o2.redirectUri || window.location.href;
    }
  ...
  */
  getIdTokenClaims(o2) {
    return instance.auth0Client.getIdTokenClaims(o2);
  }
  /**
  ...
  */
  hasRoles(roles) {
    ...
    while (roles.length) {
      ...
      const found = instance.userInfo.roles.find((r2) => r2 === next);
      if (!found) {
        return false;
      }
    }
...
async function authGuard(to2, from, next) {
  try {
    await onAuthLoaded();
    if (instance.isAuthenticated) {
      return next();
    }
    return instance.loginWithRedirect({ appState: { targetUrl: to2.fullPath } });
  } catch (e2) {
    return instance.loginWithRedirect({ appState: { targetUrl: to2.fullPath } });
  }
}
async function authSettled(to2, from, next) {
  try {
    await onAuthLoaded();
    next();
  } catch (e2) {
...
var hasRoles = (roles) => instance.hasRoles(roles);
export {
  AuthPlugin,
  authGuard,
  authSettled,
